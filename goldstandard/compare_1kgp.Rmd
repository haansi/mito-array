...
ggplot(merged_kg_deep, aes(x=Quality.deep, y=Quality.freebayes)) + geom_point(aes(color=Haplogroup.deep==Haplogroup.freebayes), alpha=0.5) +   theme(legend.position="bottom") + ggtitle("1000G Deep Byrska-Bishop et al vs. Freebayes") +  geom_abline(intercept = 0, slope = 1, color = "red", linetype = "dashed", size = 1) + ylim(0.5, 1) + xlim(0.5,1)  
